...
const Literacy2: React.FC<Literacy2Props> = ({ onNext, onBack }) => {
  ...
  const isCompleted = completedPages.includes("literacy2");
  ...
  const tasks = [
    ...
    "Visualisasikan data tersebut menggunakan grafik yang sesuai.",
    "Bandingkan hasil perhitungan rata-rata antar wilayah yang berbeda.",
  ];
  ...
  const chatMessages: ChatMessage[] = [
    {
      id: "1",
      sender: "ai",
      text: "Halo! Saya Asisten AI. Ingin bantuan dalam melakukan visualisasi atau perhitungan di CODAP?",
    },
    {
      id: "2",
      sender: "user",
      text: "Bagaimana cara melihat nilai rata-rata (mean) di grafik?",
    },
    {
      id: "3",
      sender: "ai",
      text: "Klik ikon penggaris (ruler) di sisi kanan grafik, lalu centang kotak 'Mean'. Garis rata-rata akan muncul secara otomatis pada grafikmu.",
    },
  ];
  ...
  return (
    <div className="w-screen h-screen bg-[#FDFCF8] flex flex-col p-3 overflow-hidden font-sans selection:bg-[#C6E67D] selection:text-[#0A110B]">
        ...
        <div className="w-[35%] flex flex-col gap-3 min-h-0">
          <div className="bg-white p-4 rounded-2xl border border-[#C6E67D]/30 shadow-sm flex flex-col flex-1 min-h-0">
            ...
            <div className="flex-1 flex flex-col gap-3 overflow-y-auto pr-1 custom-scrollbar">
              ...
              <div className="p-3 bg-[#C6E67D]/10 rounded-xl border border-[#C6E67D]/30 mt-auto">
                <p className="text-[10px] text-[#528C46] leading-relaxed font-medium italic text-center">
                  Gunakan visualisasi grafik untuk mempermudah perbandingan
                  polusi udara antar wilayah.
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 shrink-0">
              <button
                onClick={async () => {
                  await markPageCompleted("literacy2");
                  onNext();
                }}
          ...
          <div className="bg-[#FDFCF8] w-full max-w-4xl max-h-[90vh] flex flex-col rounded-3xl shadow-2xl overflow-hidden border border-[#C6E67D]/30 animate-in zoom-in-95 duration-300">
            ...
            <div className="p-4 bg-white border-t border-[#C6E67D]/30 shrink-0">
              <p className="text-[11px] text-[#6B7280] italic leading-relaxed w-full text-center max-w-3xl mx-auto">
                "Melihat ribuan data angka pasti membuat kita kesulitan untuk
                mengolahnya secara manual. Oleh karenanya, mari kita gunakan
                CODAP untuk membantu kita dalam mengolah data!"
              </p>
            </div>
          </div>
        </div>
      ...
      <AIChatModal
        ...
        storageKey="chat_history_literacy2"
      />
