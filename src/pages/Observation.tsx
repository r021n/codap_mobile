      ...
      <div className="flex justify-between items-center mb-2 shrink-0">
        <div className="flex gap-2">
          ...
          <div className="bg-white px-3 py-1.5 rounded-full shadow-sm border border-[#C6E67D]/30 flex items-center gap-2 group hover:border-[#528C46] transition-all duration-300">
            <div className="bg-[#528C46] w-6 h-6 rounded-full flex items-center justify-center shadow-sm shadow-[#C6E67D]/50 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="w-[45%] flex flex-col gap-2 min-h-0">
          <div className="bg-white p-3 rounded-2xl border border-[#C6E67D]/30 shadow-sm flex flex-col flex-1 min-h-0">
            <div className="flex items-center gap-2 mb-2 shrink-0">
              <div className="w-1 h-4 bg-[#528C46] rounded-full"></div>
              <h2 className="text-xs font-bold text-[#0A110B] leading-tight">
            ...
            <div className="mt-2 p-2 bg-[#FDFCF8] rounded-lg border border-dashed border-[#C6E67D] shrink-0">
              <p className="text-[9px] text-[#6B7280] flex items-center gap-1 leading-tight">
        ...
        <div className="w-[55%] flex flex-col gap-2 min-h-0">
          <div className="bg-white p-3 md:p-4 rounded-2xl border border-[#C6E67D]/30 shadow-sm flex flex-col flex-1 min-h-0 relative">
            ...
            <div className="flex-1 overflow-y-auto pr-1 space-y-2 custom-scrollbar">
              <p className="text-[10px] text-[#6B7280] mb-2 font-medium italic leading-tight">
              ...
              {questions.map((q, i) => (
                <div key={i} className="flex gap-2 group">
                  <div className="shrink-0 w-4 h-4 rounded-full bg-[#FDFCF8] flex items-center justify-center text-[#528C46] text-[9px] font-bold border border-[#C6E67D]/50 group-hover:bg-[#C6E67D]/20 transition-colors">
                    {i + 1}
                  </div>
                  <p className="text-[10px] text-[#0A110B] leading-tight pt-[1px]">
                    {q}
                  </p>
                </div>
              ))}
              ...
              <div className="mt-3 p-2 bg-[#FDFCF8] border border-[#C6E67D]/40 rounded-xl">
                <p className="text-[9px] font-bold text-[#528C46] mb-1.5 uppercase tracking-wider leading-tight">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between bg-white p-2 rounded-lg border border-[#C6E67D]/40 hover:border-[#528C46] hover:shadow-sm transition-all group"
                >
                  <span className="text-[10px] text-[#528C46] font-medium truncate mr-2 leading-tight">
                    forms.gle/maPg1qzZnj2EwzeX6
                  </span>
                  <span className="material-symbols-outlined text-[#528C46] text-[14px] group-hover:translate-x-0.5 transition-transform">
                    open_in_new
                  </span>
                </a>
              </div>
            ...
            <div className="mt-2 shrink-0">
              <button
                onClick={onNext}
                className="w-full py-2 bg-[#528C46] text-white rounded-full font-bold text-[10px] uppercase tracking-widest hover:bg-[#0A110B] hover:text-[#C6E67D] transition-colors duration-300 flex items-center justify-center gap-2"
              >
