      ...
      <div className="w-full max-w-5xl flex flex-col flex-1 min-h-0 justify-between">
        ...
        <div className="grid grid-cols-3 gap-1.5 md:gap-3 items-center flex-1 min-h-0 overflow-hidden">
          {guideItems.map((item, index) => (
            ...
            >
              <div className="flex-shrink-0 w-6 h-6 md:w-8 md:h-8 rounded-lg bg-white border border-slate-100 shadow-sm flex items-center justify-center text-green-500 group-hover:scale-105 transition-all duration-300">
        ...
        <div className="pt-2 md:pt-4">
          <button
            onClick={onNext}
            className="w-full py-2.5 md:py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg font-bold text-[8px] md:text-[9px] uppercase tracking-widest shadow-lg shadow-green-500/20 hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
          >
