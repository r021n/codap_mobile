            ...
            <div className="p-5 space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <p className="font-bold text-slate-700">Tugas LKPD 5</p>
                    <p className="text-[10px] text-slate-500 truncate max-w-[180px]">
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh] custom-scrollbar">
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 mb-6">
                <p className="text-[11px] md:text-sm text-slate-700 leading-relaxed italic">
                  ...
                  daerah Jawa Tengah: Semarang Kota, Kendal, Solo, Jepara,
                  Rembang, Cilacap, Semarang Kabupaten, dan Sragen. Data ini
                  merekam kualitas udara setiap jam selama 7 hari penuh! Ikuti
                  langkah berikut ya!"
                </p>
              </div>
