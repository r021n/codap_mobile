          ...
          <div className="bg-white p-3 md:p-5 rounded-2xl border border-[#C6E67D]/30 shadow-sm flex flex-col flex-1 min-h-0">
            <div className="flex justify-between items-center mb-4 shrink-0">
              ...
              <div className="bg-[#C6E67D]/20 px-3 py-1 rounded-full border border-[#C6E67D]/40">
                <span className="text-[10px] font-black text-[#528C46] uppercase tracking-wider">Collecting & Recording</span>
              </div>
            </div>
                  ...
                  <div key={i} className="flex gap-4 group">
                    ...
                    <p className="text-[14px] text-[#0A110B] leading-relaxed pt-[1px] font-medium">
                      {task.includes("https") ? (
                        <>
                          {task.split("https")[0]}
                          <a href={"https" + task.split("https")[1]} target="_blank" rel="noopener noreferrer" className="text-[#528C46] hover:underline font-bold break-all">
            ...
            <div className="flex-1 flex flex-col gap-3 overflow-y-auto pr-1 custom-scrollbar">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-[#6B7280] uppercase tracking-wider">Data & LKPD 5</p>
                </div>
              </button>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-[#6B7280] uppercase tracking-wider">Operasi & Refleksi</p>
                </div>
              </button>
              ...
              <div className="p-3 bg-[#C6E67D]/10 rounded-xl border border-[#C6E67D]/30 mt-auto">
                <p className="text-[10px] text-[#528C46] leading-relaxed font-medium italic text-center">
                  Kemampuan literasi data membantu kamu memahami pola polusi udara dengan lebih baik.
                </p>
              </div>
            </div>
          ...
          <div className="bg-[#FDFCF8] w-full max-w-md rounded-3xl shadow-2xl overflow-hidden border border-[#C6E67D]/30 animate-in zoom-in-95 duration-300">
             ...
             <div className="p-4 flex flex-col gap-3">
                ...
                <a href="https://forms.gle/maPg1qzZnj2EwzeX6" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-3 bg-white border border-gray-200 rounded-2xl hover:border-[#528C46] hover:shadow-md transition-all group">
                   ...
                   <div className="flex-1">
                     <p className="font-bold text-[#0A110B] text-sm">Tugas LKPD 5</p>
                ...
                <a href="https://forms.gle/Ca5q7E8cp52w9Gzc9" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-3 bg-white border border-gray-200 rounded-2xl hover:border-[#528C46] hover:shadow-md transition-all group">
                   <span className="material-symbols-outlined text-2xl text-[#528C46]">history_edu</span>
                   <div className="flex-1">
        ...
        <div className="fixed inset-0 bg-[#0A110B]/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#FDFCF8] w-full max-w-4xl max-h-[90vh] flex flex-col rounded-3xl shadow-2xl overflow-hidden border border-[#C6E67D]/30 animate-in zoom-in-95 duration-300">
             <div className="p-4 border-b border-[#C6E67D]/30 flex justify-between items-center bg-white shrink-0">
                <div className="flex items-center gap-3">
                   <span className="material-symbols-outlined text-2xl text-[#528C46]">lightbulb</span>
             ...
             <div className="p-4 bg-white border-t border-[#C6E67D]/30 shrink-0">
                <p className="text-[11px] text-[#6B7280] italic leading-relaxed w-full text-center max-w-3xl mx-auto">
                  "Halo Air Quality Specialist hebat! Kamu baru saja menerima paket data rahasia dari stasiun pemantau kualitas udara di daerah Jawa Tengah. Data ini merekam kualitas udara setiap jam selama 7 hari penuh! Ikuti langkah berikut ya!"
                </p>
             </div>
          </div>
        </div>
