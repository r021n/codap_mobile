...
const Literacy3: React.FC<Literacy3Props> = ({ onNext, onBack }) => {
  ...
  const isCompleted = completedPages.includes("literacy3");
  ...
  const chatMessages: ChatMessage[] = [
    {
      id: "1",
      sender: "ai",
      text: "Halo! Saya Asisten AI. Ingin bantuan dalam menyusun argumen atau penjelasan berdasarkan data polusi udara?",
    },
    {
      id: "2",
      sender: "user",
      text: "Bagaimana cara membuat penjelasan yang kuat dari grafik?",
    },
    {
      id: "3",
      sender: "ai",
      text: "Gunakan data numerik (seperti nilai rata-rata yang kamu hitung sebelumnya) untuk mendukung klaimmu. Misalnya: 'Kualitas udara di wilayah Industri lebih buruk karena rata-rata PM2.5 mencapai 45 µg/m³'.",
    },
  ];
  ...
  return (
    <div className="w-screen h-screen bg-[#FDFCF8] flex flex-col p-3 overflow-hidden font-sans selection:bg-[#C6E67D] selection:text-[#0A110B]">
                      ...
                      {task.includes("https") ? (
                        <>
                          ...
                          <a
                            ...
                            className="text-[#528C46] font-bold hover:underline break-all"
                          >
        ...
        <div className="w-[35%] flex flex-col gap-3 min-h-0">
          <div className="bg-white p-4 rounded-2xl border border-[#C6E67D]/30 shadow-sm flex flex-col flex-1 min-h-0">
            ...
            <div className="flex-1 flex flex-col gap-3 overflow-y-auto pr-1 custom-scrollbar">
              ...
              <div className="p-3 bg-[#C6E67D]/10 rounded-xl border border-[#C6E67D]/30 mt-auto">
                <p className="text-[10px] text-[#528C46] leading-relaxed font-medium italic text-center">
                  Gunakan visualisasi data untuk menemukan pola tersembunyi di
                  balik angka-angka polutan.
                </p>
              </div>
            </div>
            ...
            <div className="mt-4 shrink-0">
              <button
                onClick={async () => {
                  await markPageCompleted("literacy3");
                  onNext();
                }}
          ...
          <div className="bg-[#FDFCF8] w-full max-w-4xl max-h-[90vh] flex flex-col rounded-3xl shadow-2xl overflow-hidden border border-[#C6E67D]/30 animate-in zoom-in-95 duration-300">
            ...
            <div className="p-4 bg-white border-t border-[#C6E67D]/30 shrink-0">
              <p className="text-[11px] text-[#6B7280] italic leading-relaxed w-full text-center max-w-3xl mx-auto">
                "Angka-angka ini sebenarnya sedang bercerita tentang aktivitas
                manusia. Mari kita bongkar ceritanya lewat visualisasi grafik!"
              </p>
            </div>
          </div>
        </div>
      ...
      <AIChatModal 
        ...
        storageKey="chat_history_literacy3"
      />
